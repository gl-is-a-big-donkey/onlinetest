...
<body>
	...
	<div id="admin_mid">
		<div id="search_bar">
			<label class="field search" id="search_stem"> <input
				class="field__input" placeholder="输入部分或完整题目" id="get_stem"> <span
				class="field__label">题目</span>
			<button onclick="search()" id="btn_search1">搜索</button>
		</div>
	...
	<script type="text/javascript" src="scripts/searchQuestion.js"></script>
</body>
</html>